<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Edit.ascx.cs" Inherits="LIINK.Modules.LTD.LTD.Edit" %>
...
<div id="CarouselPane" runat="server" class="carousel slide" containertype="G" containername="LTD" containersrc="Blank.ascx" />
